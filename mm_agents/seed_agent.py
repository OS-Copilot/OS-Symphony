...
from ui_tars.action_parser import parsing_response_to_pyautogui_code, parse_xml_action_v3
import ast
import base64
import json
import math
...
class SeedAgent:
    ...
    def inference_with_thinking_ark(self, openai_messages):
        ...
        # 调用 OpenAI 的 chat.completions.create 方法
    ...
    def predict(self, task_instruction: str, obs: dict) -> Tuple[Union[str, Dict, None], List]:
        ...
        if len(self.history_responses) > 0:
            for history_idx, history_response in enumerate(self.history_responses):
                ...
                messages.append({
                    ...
                    "reasoning_content": history_response.split("</think_never_used_51bce0c785ca2f68081bfa7d91973934>")[
                        0].replace("<think_never_used_51bce0c785ca2f68081bfa7d91973934>", "")
                })
            messages.append({
                "role": "tool",
        ...
        logger.info(f'Seed Response: {prediction}')
